            ...
            <nav className="mt-6">
                {navLinks.map((link) => (
                    <NavLink
                        ...
                        to={link.to}
                        className={({ isActive }) =>
                            `flex items-center px-6 py-3 text-gray-600 hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200 ${isActive ? "bg-green-100 text-green-700 font-semibold" : ""
                            }`
                        }
                    >
